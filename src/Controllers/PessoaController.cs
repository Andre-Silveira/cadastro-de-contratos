...
public class PessoaController : ControllerBase{
    ...
    [HttpPost]
    public ActionResult<Object> Post([FromBody]Pessoa pessoa){
        try
        {
    ...
    public ActionResult<Object> Update([FromRoute]int id, [FromBody]Pessoa pessoa){
        ...
        catch (System.Exception)
        {
             return BadRequest(new{
                msg = $"Ocorreu algum erro ao enviar a solicitação de atualização do id {id}",
    ...
    public ActionResult<Object> Delete([FromRoute]int id){
        ...
        _context.SaveChanges();
        return Ok(new{
            msg = $"Dados do id {id} foram deletados.",
            status = HttpStatusCode.OK
        });
    }
}